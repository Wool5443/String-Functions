...
IFLAGS=-I./headers/ -I./Utils/

all: main

main: obj/main.o obj/string_functions.o
	g++ $(IFLAGS) obj/main.o obj/string_functions.o Utils/utils.o -o main

obj/main.o: main.cpp
	g++ -c $(IFLAGS) $(CFLAGS) main.cpp -o obj/main.o

obj/string_functions.o: src/string_functions.cpp
	g++ -c $(IFLAGS) $(CFLAGS) src/string_functions.cpp -o obj/string_functions.o